...
from synapsebot import constants
from synapsebot.configuration.deprecated_settings import process_temporary_deprecated_settings
from synapsebot.configuration.directory_operations import create_datadir, create_userdata_dir
from synapsebot.configuration.environment_vars import enironment_vars_to_dict
from synapsebot.configuration.load_config import load_file, load_from_files
from synapsebot.constants import Config
from synapsebot.enums import (
    NON_UTIL_MODES,
    TRADE_MODES,
    RunMode,
)
from synapsebot.exceptions import OperationalException
from synapsebot.loggers import setup_logging
from synapsebot.misc import deep_merge_dicts, parse_db_uri_for_logging, safe_value_fallback
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from synapsebot.commands.arguments import NO_CONF_ALLOWED
        ...
        from synapsebot.exchange.check_exchange import check_exchange
