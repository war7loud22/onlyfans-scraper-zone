...
from synapsebot.client.config.config_data_types import BaseClientModel
from synapsebot.client.ui.interface_utils import format_df_for_printout
from synapsebot.connector.connector_base import ConnectorBase
from synapsebot.connector.markets_recorder import MarketsRecorder
from synapsebot.core.clock import Clock
from synapsebot.core.data_type.common import MarketDict, PositionMode
from synapsebot.data_feed.candles_feed.data_types import CandlesConfig
from synapsebot.data_feed.market_data_provider import MarketDataProvider
from synapsebot.exceptions import InvalidController
from synapsebot.remote_iface.mqtt import ETopicPublisher
from synapsebot.strategy.script_strategy_base import ScriptStrategyBase
from synapsebot.strategy_v2.controllers.controller_base import ControllerBase, ControllerConfigBase
from synapsebot.strategy_v2.controllers.directional_trading_controller_base import (
    DirectionalTradingControllerConfigBase,
)
from synapsebot.strategy_v2.controllers.market_making_controller_base import MarketMakingControllerConfigBase
from synapsebot.strategy_v2.executors.data_types import PositionSummary
from synapsebot.strategy_v2.executors.executor_orchestrator import ExecutorOrchestrator
from synapsebot.strategy_v2.models.base import RunnableStatus
from synapsebot.strategy_v2.models.executor_actions import (
    CreateExecutorAction,
    ExecutorAction,
    StopExecutorAction,
    StoreExecutorAction,
)
from synapsebot.strategy_v2.models.executors_info import ExecutorInfo
...
class StrategyV2Base(ScriptStrategyBase):
    ...
    def start(self, clock: Clock, timestamp: float) -> None:
        ...
        from synapsebot.client.synapsebot_application import synapsebotApplication
        if synapsebotApplication.main_application()._mqtt is not None:
